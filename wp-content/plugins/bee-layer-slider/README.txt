...
Tags: layer slider,slideshow,layer slideshow,responsive image slider,gallery slider,banner slider,text slider,wp slider
...
Layer slider is a responsive image and text layer slider with multi text layer,background option for each slide and animations for slider .
...
Click here [Upgrade To Pro Version](https://beeplugins.com/product/layer-slider "Bee Layer Slider Pro")

**Basic Layer slider Features**

1. Layer slider is a responsive slider 
1. Single Image Layer
1. Multiple Text Layer slider
1. Background Image option for each slide
1. Create Unlimited slider
1. Text custom settings in slideshow option
1. Image Layer Custom Settings in slider option
1. 9 Animaton Effects settigs in slider option


If you face any error in slideshow kindly contact here  [Bee Plugins](https://beeplugins.com/contact "support layer slider") 
...
1. Layer slider Custom css
1. 1 year support and updates
1. Use Layer slider on unlimited domains
...
If need support for image slider kindly contact here  [Beeplugins](https://beeplugins.com/contact "support layer slider") 

**Steps to create slider**

1. Install the slider plugin.
1. Click on Bee Sliders menu
1. Add New slider
1. Add your slider title

**Image Layer**

1. Select your slide layer type image 
1. Select your  slide background image.
1. Select your slide image
1. Select your slide image in animation and out animation
1. define animation delay with multiples of 100's
1. define your image top and left position with  multiples of 100's

**Text Layer**

1. Select your slide layer type text 
1. Type your text.
1. Select your slide text in animation and out animation
1. define animation delay with multiples of 100's
1. define your text top and left position with  multiples of 100's
