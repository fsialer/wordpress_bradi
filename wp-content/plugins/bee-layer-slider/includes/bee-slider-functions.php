...
function bee_layer_pro_notice() {
    ...
    <div class="notice  is-dismissible" >
       <a style="text-decoration:none;" href="http://beeplugins.com/product/layer-slider" target="_blank"><img src="<?php echo plugin_dir_url( __FILE__ ).'../public/css/images/layer_pro.png'; ?>" alt="upgrade pro version" /></a>
    </div>
